...
def check_translate(original_text: str, translated_text: str, threshold_percent: float = 5.0) -> bool:
    """
...
async def main():
    ...
    for book_name, chapters in data.items():
        ...
        for chapter_name, pairs in chapters.items():
            ...
            # if "CHAPTER XXIV" in chapter_name or started:
            #     started = True
            ...
            try:
                res = await translate_chapter_text(full_chapter_en,chapter_name,book_name)
